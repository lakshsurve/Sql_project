...
- **Sql Server Management Studio:** The chosen database management system, ideal for handling the job posting data.
...
﻿WITH skills_demand AS (
    ...
    WHERE
        ...
        AND j.job_work_from_home = 'True'    -- ✅ FIXED: compare as text
    GROUP BY
        s.skill_id,
        s.skills
), 
